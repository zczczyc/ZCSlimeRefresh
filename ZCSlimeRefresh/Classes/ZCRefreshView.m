...
@implementation ZCRefreshView {
    ...
    CGPoint _activityIndicatorViewCenter;
}
...
- (id)initWithHeight:(CGFloat)height
{
    ...
    if (self) {
        _slime = [[ZCSlimeView alloc] initWithFrame:
        ...
        NSURL *url = [bundle URLForResource:@"ZCSlimeRefresh" withExtension:@"bundle"];
        NSBundle *imageBundle = [NSBundle bundleWithURL:url];
        UIImage *sr_refreshImage = [UIImage imageNamed:@"sr_refresh" inBundle:imageBundle compatibleWithTraitCollection:nil];
        _refreshView = [[UIImageView alloc] initWithImage:sr_refreshImage];
        ...
        _activityIndicatorViewCenter = _slime.startPoint;
...
- (void)pullApart:(ZCRefreshView*)refreshView
{
    //拉断了
    self.broken= YES;
    _unmissSlime = YES;
...
- (void)fixRefresh {
    ...
    //wlq add 20180423
    CGPoint activityIndicatorViewCenter = _activityIndicatorViewCenter;
    activityIndicatorViewCenter.x = _slime.toPoint.x;
    _activityIndicatorView.center = activityIndicatorViewCenter;
}
